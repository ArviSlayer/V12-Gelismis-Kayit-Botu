...
exports.run = async (client, message, args) => {
    ...
    let kayitLog = message.guild.channels.cache.get(eayarlar.reg["ERKEK KAYIT LOG KANALININ ID'Sİ"]); 
    ...
    await arvis.roles.add(["ERKEK ROL ID 1", "ERKEK ROL ID 2"])
    ...
    database.push(`isimler_${arvis.id}`, `${arvis_tamisim} [**<@&ERKEK_ROL_ID>**]`);
